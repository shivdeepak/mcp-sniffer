            ...
            <td className="px-2 flex flex-row items-center">
              <div
                className={`w-2 h-2 m-1.5 rounded-full ${
                  connection.response.status_code >= 500
                    ? 'bg-red-500'
                    : connection.response.status_code >= 400
                      ? 'bg-orange-500'
                      : connection.response.status_code >= 300
                        ? 'bg-blue-500'
                        : 'bg-green-500'
                }`}
              ></div>
              ...
              <div className="text-sm pl-2">
                {connection.response.status_message}
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td className="px-2">
              {connection.destination_ip}:{connection.destination_port}
            </td>
          </tr>
        </tbody>
      </table>
