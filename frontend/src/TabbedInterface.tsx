  ...
  return (
    <div className="w-full">
      <div className="flex bg-gray-300">
        ...
        <button onClick={onClose} className="text-sm flex-1 cursor-pointer">
          x
        </button>
      </div>
      ...
      <div className="p-4">
        ...
        {activeTab === 'request-raw' && (
          <ShowRequestRaw connection={connection} />
        )}
        {activeTab === 'response-raw' && (
          <ShowResponseRaw connection={connection} />
        )}
        {activeTab === 'response-sse' && (
          <ShowResponseSSE connection={connection} />
        )}
        {activeTab === 'response-chunks' && (
          <ShowResponseChunks connection={connection} />
        )}
      </div>
    </div>
  )
